...
def generated_source(fixture: Path) -> str:
    ...
    return format_rust(f'''//! Generated semantic timing and hit reactions for hostile contact against the player craft.
//!
//! Source: `player_damage.json`, reduced from clean projectile and Eladard-contact traces.
//! Compound collision geometry is now extracted separately from the ROM.
