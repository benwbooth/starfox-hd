-- Capture pre-instruction state for the first $01:D9FF Super FX job.
...
local function stop()
  ...
  local file = assert(io.open(
    emu.getScriptDataFolder() .. "/d9ff-register-trace.txt", "wb"))
  file:write(table.concat(lines))
  file:close()
  emu.log("SF2_D9FF_REGISTER_TRACE_DONE")
  emu.stop(0)
end
