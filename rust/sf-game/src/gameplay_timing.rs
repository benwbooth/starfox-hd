...
const CORNERIA_NEUTRAL_MOTION_REFRESHES: [u8; CORNERIA_NEUTRAL_MEASURED_FRAMES] = [
    ...
    6, 8, 8, 6, 8, 7, 8, 6, 7, 7, 7, 6, 6, 6, 6, 4, 6, 6, 6, 6, 6, 6, 5, 6, 4, 6, 4, 6, 6, 6, 6, 6,
    6, 4, 6, 4, 5, 5, 5, 6, 4, 6, 7, 6, 5, 7, 7, 6, 5, 6, 5, 6, 5, 7, 4, 4, 5, 6, 6, 6, 6, 4, 6, 6,
    4, 6, 4, 6, 4, 6, 6, 6, 6, 6, 6, 4, 6, 6, 6, 6, 4, 6, 7, 5, 4, 7, 6, 6, 7, 4, 6, 6, 6, 6, 5, 5,
    6, 6, 6, 6, 6, 5, 6, 6, 6, 7, 6, 7, 6, 6, 4, 6, 4, 6, 6, 4, 5, 5, 4, 5, 4, 6, 4, 4, 5, 5, 5, 5,
    5, 3, 5, 4, 5, 4, 5, 4, 5, 5, 5, 3, 4, 5, 5, 5, 5, 5, 4, 4, 4, 4, 5, 6, 6, 6, 6, 5, 6, 5, 6, 5,
    5, 6, 5, 5, 5, 5, 4, 3, 4, 4, 4, 5, 4, 4, 5, 4, 5, 5, 5, 3, 4, 5, 3, 5,
];
...
const CORNERIA_NEUTRAL_PRESENTATION_REFRESHES: [u8; CORNERIA_NEUTRAL_MEASURED_FRAMES] = [
    ...
    7, 7, 5, 8, 8, 6, 8, 6, 9, 8, 6, 7, 4, 7, 9, 6, 6, 4, 6, 6, 6, 6, 6, 6, 6, 5, 4, 6, 3, 7, 6, 6,
    6, 6, 6, 3, 7, 4, 4, 7, 5, 5, 3, 7, 6, 7, 4, 7, 7, 7, 6, 5, 4, 5, 6, 7, 4, 5, 6, 5, 6, 6, 6, 3,
    7, 6, 3, 7, 4, 6, 3, 7, 6, 6, 6, 6, 6, 3, 7, 6, 6, 6, 3, 7, 6, 4, 5, 7, 7, 4, 8, 4, 7, 6, 6, 6,
    6, 5, 5, 6, 6, 6, 6, 6, 5, 6, 6, 6, 7, 6, 7, 6, 3, 7, 3, 7, 6, 3, 7, 5, 5, 4, 3, 6, 3, 5, 6, 5,
    5, 5, 5, 3, 5, 5, 4, 5, 4, 5, 4, 5, 5, 3, 5, 4, 5, 5, 5, 5, 3, 3, 4, 4, 7, 5, 6, 6, 6, 6, 5, 6,
    6, 4, 6, 6, 5, 5, 5, 5, 5, 2, 5, 4, 4, 4, 5, 4, 4, 5, 4, 5, 5, 3, 5, 4, 3, 5, 5, 3,
];
