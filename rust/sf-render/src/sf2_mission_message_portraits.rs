...
//!
//! Source: oracle screen sequence `mesen_audio_events_oracle`.
//! Regenerate with `tools/sf2/generate_mission_message_portraits.py`.

pub const LEFT: i32 = 49;
...
pub const THIN_LINE_FRAME: usize = 0;
pub const EMPTY_PANEL_FRAME: usize = 1;
pub const SPARSE_INTERFERENCE_FRAME: usize = 2;
pub const DENSE_INTERFERENCE_FRAME: usize = 3;
pub const FULL_INTERFERENCE_FRAME: usize = 4;
pub const SLIPPY_TALKING_FRAME: usize = 5;
pub const SLIPPY_STILL_FRAME: usize = 6;
const CHANNELS_PER_PIXEL: usize = 4;
#[cfg(test)]
const SOURCE_RGBA_FNV1A: u32 = 0xACAEE41E;
const PALETTE: [[u8; CHANNELS_PER_PIXEL]; 20] = [
    [0, 0, 57, 0],
    [0, 0, 24, 0],
    [0, 0, 41, 0],
    [0, 0, 0, 0],
