...
pub fn build() -> Route2Level {
    ...
    b.pathobj(5000, 0x0300, -0x100, 3000, SH_PAPER_1_PROXY, PATH_ID_PAPER_1B, 10, 10);
    b.pathobj(6000, -0x200, 0x100, 3000, SH_PAPER_1_PROXY, PATH_ID_PAPER_1B, 10, 10);
    b.pathobj(6000, 0x0200, -0x100, 4000, SH_PAPER_1_PROXY, PATH_ID_PAPER_1B, 10, 10);
    b.pathobj(10000, 0x0100, -0x400, 1500, SH_PAPER_1_PROXY, PATH_ID_PAPER_1B, 10, 10);
    b.mapobj(8000, 0, 0, 4000, SH_POLE_0_PROXY, STRAT_ADDR_POLE0);

    // Lines 12-24: paper plane wave 2 + poles
    b.pathobj(5000, -0x200, 0x0200, 3000, SH_PAPER_1_PROXY, PATH_ID_PAPER_1B, 10, 10);
    b.pathobj(5000, 0x0100, -0x100, 3000, SH_PAPER_1_PROXY, PATH_ID_PAPER_1B, 10, 10);
    b.pathobj(5000, -0x200, 0x400, 1500, SH_PAPER_1_PROXY, PATH_ID_PAPER_1B, 10, 10);
    b.pathobj(6000, -0x400, 0x150, 3000, SH_PAPER_3_PROXY, PATH_ID_PAPER_1B, 10, 10);
    b.mapobj(6000, 0, -0x200, 4000, SH_POLE_0_PROXY, STRAT_ADDR_POLE0);
    b.mapobj(6000, -0x100, 0x100, 4000, SH_POLE_0_PROXY, STRAT_ADDR_POLE0);
    b.pathobj(6000, 0x0400, 0, 3000, SH_PAPER_1_PROXY, PATH_ID_PAPER_1B, 10, 10);
    b.pathobj(6000, 0, -0x400, 1500, SH_PAPER_1_PROXY, PATH_ID_PAPER_1B, 10, 10);
    b.pathobj(8000, 0x0200, 0x200, 2000, SH_PAPER_3_PROXY, PATH_ID_PAPER_1B, 10, 10);
    b.pathobj(1000, 0, 0x0100, 3000, SH_PAPER_1_PROXY, PATH_ID_PAPER_1B, 10, 10);
    b.pathobj(1000, -0x300, 0x200, 3000, SH_PAPER_1_PROXY, PATH_ID_PAPER_1B, 10, 10);
    b.pathobj(5000, -0x100, -0x400, 1000, SH_PAPER_1_PROXY, PATH_ID_PAPER_1B, 10, 10);
    b.pathobj(4000, 0, -0x400, 1500, SH_PAPER_1_PROXY, PATH_ID_PAPER_1B, 10, 10);

    // Lines 26-27: paper pair
    b.pathobj(2000, -0x300, 0, 3000, SH_PAPER_1_PROXY, PATH_ID_PAPER_1B, 10, 10);
    b.pathobj(2000, -0x300, 0x100, 3000, SH_PAPER_1_PROXY, PATH_ID_PAPER_1B, 10, 10);

    // Lines 29-34: mixed paper_3 / paper_1 wave
    b.pathobj(5000, -0x200, 0x200, 4000, SH_PAPER_3_PROXY, PATH_ID_PAPER_1B, 10, 10);
    b.pathobj(3000, 0, 0x200, 4000, SH_PAPER_3_PROXY, PATH_ID_PAPER_1B, 10, 10);
    b.pathobj(10000, 0x200, 0x200, 4000, SH_PAPER_3_PROXY, PATH_ID_PAPER_1B, 10, 10);
    b.pathobj(5000, 0x0300, 0x100, 3000, SH_PAPER_1_PROXY, PATH_ID_PAPER_1B, 10, 10);
    b.pathobj(6000, -0x200, 0x100, 3000, SH_PAPER_1_PROXY, PATH_ID_PAPER_1B, 10, 10);
    b.pathobj(10000, 0x0200, 0x100, 4000, SH_PAPER_1_PROXY, PATH_ID_PAPER_1B, 10, 10);
    ...
    b.pathobj(0, 3000, 0, 4200, SH_SLOT_0_PROXY, PATH_ID_SLOTMACHINE, 10, 10);
    ...
    // TODO: b.setvarw(WM_HPOSJMP, rotate_hof_addr);
    ...
    b.mapobj(0, 1550 + 29, 1323 + 54, 1000, SH_FONT_N2_PROXY, STRAT_ADDR_THEEND_N);
    b.mapobj(0, -1050 + 129, 1428, 1000, SH_FONT_D2_PROXY, STRAT_ADDR_THEEND_D);
