...
fn append_map2_6a(b: &mut MapBuilder) -> Map26Ptrs {
    ...
    b.mapobj(800, -100, -60, 1800, SH_BOU_1B_PROXY, IS_HARD180YR);
    b.cspecial(0, 10, -40, 3000, SH_CAR_1, IS_TRUCK1);
    b.mapobj(800, -100, -60, 2600, SH_WALL_4_PROXY, IS_HARD180YR);
    b.mapobj(0, -200, -60, 4000, SH_WALL_4_PROXY, IS_HARD180YR);
    b.mapobj(800, -100, -60, 3200, SH_WALL_4_PROXY, IS_HARD180YR);
    b.special(0, -200, -40, 3000, SH_CAR_1, IS_TRUCK1);
    b.mapobj(800, -100, -60, 4000, SH_BOU_1B_PROXY, IS_HARD180YR);
    b.mapobj(800, -100, -60, 4000, SH_WALL_4_PROXY, IS_HARD180YR);
    ...
    b.mapobj(0, 80, -60, 4000, SH_BOU_1B_PROXY, IS_HARD180YR);
    ...
    b.mapobj(800, -90, -60, 4000, SH_WALL_4_PROXY, IS_HARD180YR);
    b.cspecial(0, -800, 60, 1000, SH_CAR_0, IS_AIRCAR1);
    b.mapobj(800, -80, -60, 4000, SH_WALL_4_PROXY, IS_HARD180YR);
    b.mapobj(800, -70, -60, 4000, SH_WALL_4_PROXY, IS_HARD180YR);
    let bonus0 = b.mapcode65816_inline();
    b.mapobj(0, 60, -50, 1500, SH_ITEM_7, IS_ITEM7);
    b.label("level2_6.map2_6a.skillfly_bonus_0_skip");
    b.mapobj(800, -60, -60, 4000, SH_WALL_4_PROXY, IS_HARD180YR);
    b.mapobj(800, -50, -60, 4000, SH_WALL_4_PROXY, IS_HARD180YR);
    b.mapobj(800, -40, -60, 4000, SH_WALL_4_PROXY, IS_HARD180YR);
    b.mapobj(800, 60, -60, 4000, SH_WALL_4_PROXY, IS_HARD180YR);
    b.mapobj(800, -60, -60, 4000, SH_WALL_4_PROXY, IS_HARD180YR);
    b.mapobj(1200, 60, -60, 4000, SH_WALL_4_PROXY, IS_HARD180YR);

    b.cspecial(1600, -1000, 60, 3000, SH_CAR_0, IS_AIRCAR4);
    b.mapobj(800, -60, -60, 4000, SH_WALL_4_PROXY, IS_HARD180YR);
    b.cspecial(1600, 0, -60, 3500, SH_CAR_0, IS_AIRCAR4);
    b.mapobj(800, 60, -60, 4000, SH_WALL_4_PROXY, IS_HARD180YR);
    b.mapobj(1000, -60, -60, 4000, SH_WALL_4_PROXY, IS_HARD180YR);

    b.mapobj(0, -300, -60, 4000, SH_BOU_1B_PROXY, IS_HARD180YR);
    ...
    b.mapobj(1000, -300, -60, 4000, SH_BOU_1B_PROXY, IS_HARD180YR);
    b.mapobj(0, -300, -60, 4000, SH_BOU_1B_PROXY, IS_HARD180YR);
    ...
    b.mapobj(200, -100, -60, 4000, SH_WALL_4_PROXY, IS_HARD180YR);
    b.mapobj(400, -100, -60, 4000, SH_WALL_4_PROXY, IS_HARD180YR);
    ...
    b.mapobj(400, -100, -60, 4000, SH_WALL_4_PROXY, IS_HARD180YR);
    b.mapobj(0, -300, -60, 4000, SH_BOU_1B_PROXY, IS_HARD180YR);
    b.mapobj(0, -300, -60, 4200, SH_BOU_1B_PROXY, IS_HARD180YR);
    ...
    b.mapobj(0, 80, -60, 4000, SH_WALL_4_PROXY, IS_HARD180YR);
    b.mapobj(0, -40, -60, 4000, SH_WALL_4_PROXY, IS_HARD180YR);
    b.mapobj(0, -160, -60, 4000, SH_WALL_4_PROXY, IS_HARD180YR);
    b.mapobj(0, -280, -60, 4000, SH_WALL_4_PROXY, IS_HARD180YR);
...
fn append_cl_colon(b: &mut MapBuilder) {
    ...
    b.mapobj(800, 0, -60, 4200, SH_PIPE_8_0_PROXY, IS_NOCOLL);
