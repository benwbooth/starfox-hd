...
mod lc {
    ...
    pub const SH_GRO_0_PROXY: u16 = sh::BU_0;
    pub const SH_GRO_1_PROXY: u16 = sh::BU_0;
    pub const SH_GRO_4_PROXY: u16 = sh::BU_1;
    pub const SH_GRO_5_PROXY: u16 = sh::BU_1;
    pub const SH_GRO_6_PROXY: u16 = sh::BU_2;
    pub const SH_BASE_0_0_PROXY: u16 = sh::NULLSHAPE;
    pub const SH_BASE_0_1_PROXY: u16 = sh::NULLSHAPE;
    pub const SH_BTANK_1_PROXY: u16 = SH_S_TANK_0;
    pub const SH_TANK_2_PROXY: u16 = SH_S_TANK_0;
    pub const SH_BOSS_H_0_PROXY: u16 = sh::NULLSHAPE;
...
pub fn build() -> Route1Level {
    ...
    b.mapobj(0x0000, -0x0800, 0, 0x8000, lc::SH_GRO_6_PROXY, is::HARD180YR);
    b.mapobj(0x0000, 0x1000, 0, 0x10000, lc::SH_GRO_6_PROXY, is::HARD180YR);
    b.mapobj(0x0000, -0x1200, 0, 0x12000, lc::SH_GRO_6_PROXY, is::HARD180YR);
    ...
    b.pathspecial(0x0000, -0x0800, 0, 3000, lc::SH_S_TANK_0, lc::PATH_ID_E_TANK, 10, 10);
    b.pathspecial(0x4000, 0x0800, 0, 3000, lc::SH_S_TANK_0, lc::PATH_ID_E_TANK, 10, 10);

    // MAP1_4.ASM:24-25 — friend chase6
    b.pathobj(0x0000, -0x0750, -400, 0, sh::FRIENDSHIP_4, path::CHASE6_1, 10, 10);
    b.pathcspecial(0x2500, -0x0720, -400, 0, sh::ZACO_A, path::CHASE6_2, 10, 10);

    // MAP1_4.ASM:27-29 — more tanks
    b.pathspecial(0x1500, 0, 0, 3000, lc::SH_S_TANK_0, lc::PATH_ID_E_TANK, 10, 10);
    b.pathcspecial(0x0000, -0x0450, 0, 3000, lc::SH_TANK_1, lc::PATH_ID_E_TANK, 10, 10);
    b.pathcspecial(0x8000, 0x0450, 0, 3000, lc::SH_TANK_1, lc::PATH_ID_E_TANK, 10, 10);
    ...
    b.mapobj(0x0100, 0x0050, 0, 1500, lc::SH_GRO_6_PROXY, lc::IS_HARD180YRFOG);
    b.pathcspecial(0x1000, -0x0050, 0, 2050, lc::SH_WALKER_0, lc::PATH_ID_E_WALK_1, 10, 10);

    b.mapobj(0x0000, -0x0800, 0, 2000, lc::SH_GRO_4_PROXY, lc::IS_HARD180YRFOG);
    b.mapobj(0x1000, 0x0600, 0, 2000, lc::SH_GRO_5_PROXY, lc::IS_HARD180YRFOG);
    b.mapobj(0x0000, -0x0600, 0, 2000, lc::SH_GRO_4_PROXY, lc::IS_HARD180YRFOG);
    b.mapobj(0x0000, 0x0400, 0, 2000, lc::SH_GRO_5_PROXY, lc::IS_HARD180YRFOG);
    b.pathcspecial(0x1000, 0x0350, 0, 2550, lc::SH_WALKER_0, lc::PATH_ID_E_WALK_1, 10, 10);

    b.mapobj(0x0000, -0x0300, 0, 2000, lc::SH_GRO_4_PROXY, lc::IS_HARD180YRFOG);
    b.mapobj(0x1000, 0x0400, 0, 2000, lc::SH_GRO_5_PROXY, lc::IS_HARD180YRFOG);
    b.pathcspecial(0x0000, 0, 0, 3000, lc::SH_TANK_1, lc::PATH_ID_E_TANK, 10, 10);
    b.mapobj(0x0000, -0x0280, 0, 2000, lc::SH_GRO_0_PROXY, lc::IS_HARD180YRFOG);
    b.mapobj(0x1000, 0x0280, 0, 2000, lc::SH_GRO_1_PROXY, lc::IS_HARD180YRFOG);
    b.mapobj(0x0000, -0x0250, 0, 2000, lc::SH_GRO_0_PROXY, lc::IS_HARD180YRFOG);
    b.pathspecial(0x0000, -0x0300, 0, 3000, lc::SH_S_TANK_0, lc::PATH_ID_E_TANK, 10, 10);
    b.mapobj(0x1000, 0x0250, 0, 2000, lc::SH_GRO_1_PROXY, lc::IS_HARD180YRFOG);
    ...
    b.pathspecial(0x1000, 0x0450, 0, 3000, lc::SH_S_TANK_0, lc::PATH_ID_E_TANK, 10, 10);
    b.mapobj(0x1000, 0x0900, 0, 4000, lc::SH_GRO_6_PROXY, is::HARD180YR);
    b.mapobj(0x1000, -0x0900, 0, 4000, lc::SH_GRO_6_PROXY, is::HARD180YR);
    b.pathcspecial(0x0000, -0x0800, -170, -100, lc::SH_HELI, lc::PATH_ID_KAMOME, 10, 10);
    ...
    b.pathcspecial(0x1500, 0x0600, 0, 5300, lc::SH_WALKER_0, lc::PATH_ID_E_WALK_1, 10, 10);

    // MAP1_4.ASM:125-132 — friend chase7 + more heli
    b.pathobj(0x0000, 0, -400, -150, sh::FRIENDSHIP_4, lc::PATH_ID_CHASE7_1, 10, 10);
    b.pathcspecial(0x1000, 0, -400, -150, sh::ZACO_A, lc::PATH_ID_CHASE7_2, 10, 10);
    b.pathcspecial(0x0000, -0x0800, -170, -100, lc::SH_HELI, lc::PATH_ID_KAMOME, 10, 10);
    b.mapobj(0x1000, 0x0900, 0, 4000, lc::SH_GRO_6_PROXY, is::HARD180YR);
    b.pathcspecial(0x0000, 0x0800, -170, -100, lc::SH_HELI, lc::PATH_ID_KAMOME, 10, 10);
    b.mapobj(0x1000, -0x0900, 0, 4000, lc::SH_GRO_6_PROXY, is::HARD180YR);
    ...
    b.pathcspecial(0x0000, 0x0450, 0, 6000, lc::SH_WALKER_0, lc::PATH_ID_E_WALK_1, 10, 10);
    ...
    b.mapobj(0x0000, -0x1500, 0, 8000, lc::SH_BASE_0_0_PROXY, lc::IS_BASE0);
    b.special(0x0000, -0x1500, 0, 8004, lc::SH_S_TANK_0, lc::IS_TANK1A);
    b.setalvarb(al::SBYTE1, 50);
    b.cspecial(0x0000, -0x1200, 0, 8004, lc::SH_BTANK_1_PROXY, lc::IS_TANK1A);
    b.setalvarb(al::SBYTE1, 55);
    b.cspecial(0x0000, -0x0900, 0, 8004, lc::SH_BTANK_1_PROXY, lc::IS_TANK1A);
    b.setalvarb(al::SBYTE1, 60);
    b.mapobj(0x3000, -0x1500, 0, 8005, lc::SH_BASE_0_1_PROXY, lc::IS_BASE0);
    ...
    b.pathobj(0x0000, 0x0750, -100, 0, sh::FRIENDSHIP_4, path::CHASE8_1, 10, 10);
    b.pathcspecial(0x0000, 0x3800, -3600, 4260, sh::ZACO_A, path::CHASE8_2, 10, 10);
    ...
    b.pathobj(0x1000, 3000, 3000, 3000, sh::NULLSHAPE, path::E_GATE, 10, 10);
    ...
    b.pathobj(0x0000, 0x0300, -600, 3000, lc::SH_HELI, lc::PATH_ID_KAMOME, 10, 10);
    b.pathobj(0x0000, -0x0300, -600, 3000, lc::SH_HELI, lc::PATH_ID_KAMOME, 10, 10);
    ...
    b.pathobj(0x0000, -0x0100, -400, -150, sh::FRIENDSHIP_4, lc::PATH_ID_CHASE7_1, 10, 10);
    b.pathcspecial(0x0000, -0x0100, -400, -150, sh::ZACO_A, lc::PATH_ID_CHASE7_2, 10, 10);
    b.cspecial(0x0000, -0x0100, 0, 4000, lc::SH_TANK_2_PROXY, lc::IS_TANK2);
    b.pathobj(0x0000, 0x0300, -600, 3000, lc::SH_HELI, lc::PATH_ID_KAMOME, 10, 10);
    b.pathobj(0x0000, -0x0300, -600, 2500, lc::SH_HELI, lc::PATH_ID_KAMOME, 10, 10);
    b.pathobj(0x1000, 0, -600, 2000, lc::SH_HELI, lc::PATH_ID_KAMOME, 10, 10);
    b.mapobj(0x1000, 0x0900, 0, 4000, lc::SH_GRO_6_PROXY, is::HARD180YR);
    b.mapobj(0x1000, -0x0900, 0, 4000, lc::SH_GRO_6_PROXY, is::HARD180YR);
    b.mapobj(0x1000, 0x0900, 0, 4000, lc::SH_GRO_6_PROXY, is::HARD180YR);
    b.mapobj(0x1000, -0x1000, 0, 4000, lc::SH_GRO_6_PROXY, is::HARD180YR);
