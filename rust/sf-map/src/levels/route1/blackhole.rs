...
mod lc {
    ...
    /// levels.c `#define STRAT_ADDR_MOTHER1 0x020000u`
    pub const STRAT_ADDR_MOTHER1: u32 = 0x020000;
    /// levels.c `#define STRAT_ADDR_MOTHER2 0x020001u`
...
pub fn build() -> Route1Level {
    ...
    b.mapmother(0x8000, 0, 0, 5000, lc::SH_MOTHER1, lc::STRAT_ADDR_MOTHER1, 0);
    ...
    b.mapmother(0x4000, 0, 0, 5000, lc::SH_MOTHER1, lc::STRAT_ADDR_MOTHER1, 0);
    ...
    b.mapmother(0x4000, 0, 0, 4000, lc::SH_MOTHER1, lc::STRAT_ADDR_MOTHER1, 0);
    ...
    b.mapmother(0x0400, 0, 0, 4000, lc::SH_MOTHER1, lc::STRAT_ADDR_MOTHER2, 0);
    // Line 26: maprem mother1
    b.mapremove(lc::SH_MOTHER1);

    // Line 27: mapmother 02000,0000,0,5000,mother1,mother1_istrat,map_bhole
    b.mapmother(0x2000, 0, 0, 5000, lc::SH_MOTHER1, lc::STRAT_ADDR_MOTHER1, 0);
