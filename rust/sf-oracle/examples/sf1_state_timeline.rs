...
use sf_oracle::{
    ...
    RETAIL_DEFAULT_TRAINING, RETAIL_DOSTRATS, RETAIL_FADEDIR, RETAIL_GAMEFRAME,
    RETAIL_INIT_STRATS_L, RETAIL_KILL_LIST, RETAIL_NEWOBJS_L, RETAIL_PEPPER_CHARACTERS,
