...
pub const ALTERNATE_EXHAUST: PathCursor = cursor(0, 1497);
pub const COLOR_CYCLE_SPRITE: PathCursor = cursor(0, 1533);
pub const RANDOMIZED_COLOR_PARTICLE: PathCursor = cursor(0, 1295);
pub const LOCAL_JITTER_SPRITE: PathCursor = cursor(0, 1489);
pub const AUXILIARY_GATED_SPRITE: PathCursor = cursor(0, 1359);
pub const CHILD_DETACHING_SPRITE: PathCursor = cursor(0, 1502);
pub const REPEATED_CHILD_SPRITE: PathCursor = cursor(0, 1514);
pub const SOUND_COLOR_SPRITE: PathCursor = cursor(0, 1524);
pub const CALLBACK_GATED_SPRITE: PathCursor = cursor(0, 1341);
pub const PRIMARY_MOTION_GROUND_LIMITED: PathCursor = cursor(0, 1246);
pub const PRIMARY_TARGET_FOLLOWER: PathCursor = cursor(0, 1370);
pub const SHARED_COUNTDOWN_SERVICE: PathCursor = cursor(0, 35);
pub const COUNTER_MOTION_EFFECT: PathCursor = cursor(0, 873);
pub const PLAYER_CHARGE_ORB: PathCursor = cursor(0, 1261);
...
pub const SURFACE_OR_GROUND_LIMITED: PathCursor = cursor(0, 1149);
pub const PRIMARY_MOTION_SURFACE_LIMITED: PathCursor = cursor(0, 1071);
pub const OCCUPANCY_SURFACE_LIMITED: PathCursor = cursor(0, 954);
pub const DOUBLED_MOTION_HOMING_PROJECTILE: PathCursor = cursor(0, 1081);
pub const PRIMARY_MOTION_HOMING_PROJECTILE: PathCursor = cursor(0, 1086);
pub const DIFFICULTY_HOMING_PROJECTILE: PathCursor = cursor(0, 1092);
pub const VARIANT_GUIDED_PROJECTILE: PathCursor = cursor(0, 1173);
pub const OFFSET_GUIDED_PROJECTILE: PathCursor = cursor(0, 987);
pub const LINKED_PROTECTION_EFFECT: PathCursor = cursor(0, 1307);
pub const TRIGGERED_LINKED_PROJECTILE: PathCursor = cursor(0, 1445);
pub const ATTACHED_RECOVERY_EFFECT: PathCursor = cursor(0, 1379);
...
pub const PHASE_GROWTH_FADE_SPRITE: PathCursor = cursor(0, 888);
pub const SOLID_SPRITE_HOLD: PathCursor = cursor(0, 196);
pub const BIASED_DEPTH_HOLD: PathCursor = cursor(0, 900);
...
pub const FOOTPRINT_YAW_EFFECT: PathCursor = cursor(0, 1283);
pub const TIMED_FALLING_YAW_EFFECT: PathCursor = cursor(0, 1278);
pub const RESET_ANIMATION_YAW_EFFECT: PathCursor = cursor(0, 1289);
pub const SIX_STEP_SHAPE_EFFECT: PathCursor = cursor(0, 883);
pub const DEPTH_BIASED_WAIT_EFFECT: PathCursor = cursor(0, 1566);
...
pub const RANDOM_TEXTURE_CONTACT_SPRITE: PathCursor = cursor(0, 1547);
...
pub const CONTACT_SUPPRESSED_ATTACHMENT: PathCursor = cursor(0, 823);
pub const CLIPPED_SHADOWLESS_ATTACHMENT: PathCursor = cursor(0, 652);
pub const DEFERRED_FAST_CONTACT_MESH: PathCursor = cursor(0, 1556);
...
pub const HEIGHT_SELECTED_ARC_EFFECT: PathCursor = cursor(0, 847);
...
pub const SIGNAL_GATED_LOOPING_MESH: PathCursor = cursor(0, 825);
pub const ACTION_GATED_SOUND_HOLD: PathCursor = cursor(0, 897);
pub const ACTION_GATED_ANIMATED_RETIREMENT: PathCursor = cursor(0, 908);
pub const TIMED_SPIN_RISE_EFFECT: PathCursor = cursor(0, 920);
pub const HIT_DETACHED_BOUNCING_PART: PathCursor = cursor(0, 778);
pub const HIT_DRIVEN_ROTATING_PART_CONTROLLER: PathCursor = cursor(0, 811);
pub const LOWERED_ROOT_COUNT: usize = 100;
pub const LOWERED_COMMAND_COUNT: usize = 1570;
pub const LOWERED_SOURCE_COMMAND_COUNT: usize = 1579;
pub fn catalog() -> PathCatalog {
    PathCatalog::new(vec![vec![
        ...
        Statement::Control(ControlCommand::Register {
            trigger: Trigger::timed(cursor(0, 783), TriggerKind::TimerPenultimate, 30),
            next: cursor(0, 789),
        }),
        Statement::StackValue {
            command: super::path_commands::StackValueCommand::SaveByte(ByteField::Rotation(
        ...
        Statement::Control(ControlCommand::Register {
            trigger: Trigger::timed(cursor(0, 1053), TriggerKind::Always, 13),
            next: cursor(0, 1038),
        }),
        Statement::Control(ControlCommand::Hold),
        Statement::Control(ControlCommand::Cancel {
        ...
        Statement::Control(ControlCommand::Return),
        Statement::Control(ControlCommand::Register {
            trigger: Trigger::timed(cursor(0, 1281), TriggerKind::Always, 30),
            next: cursor(0, 1279),
        }),
        Statement::Mutate {
            mutation: Mutation::Byte {
        ...
        Statement::UpdateProtectionEffect {
            ordinary_return: cursor(0, 1326),
            flicker: cursor(0, 1327),
        },
        Statement::Control(ControlCommand::Return),
        Statement::Mutate {
            mutation: Mutation::Byte {
        ...
        Statement::Control(ControlCommand::Register {
            trigger: Trigger::timed(cursor(0, 1438), TriggerKind::Always, 35),
            next: cursor(0, 1393),
        }),
        Statement::Contact {
            command: ContactCommand::RetainClass(ContactClassMask {
        ...
        Statement::Control(ControlCommand::Register {
            trigger: Trigger::timed(cursor(0, 1436), TriggerKind::Always, 25),
            next: cursor(0, 1399),
        }),
        Statement::Wait {
            duration: ByteOperand::Literal(5),
