...
pub const ALTERNATE_EXHAUST: PathCursor = cursor(0, 727);
pub const COLOR_CYCLE_SPRITE: PathCursor = cursor(0, 763);
pub const RANDOMIZED_COLOR_PARTICLE: PathCursor = cursor(0, 525);
pub const LOCAL_JITTER_SPRITE: PathCursor = cursor(0, 719);
pub const AUXILIARY_GATED_SPRITE: PathCursor = cursor(0, 589);
pub const CHILD_DETACHING_SPRITE: PathCursor = cursor(0, 732);
pub const REPEATED_CHILD_SPRITE: PathCursor = cursor(0, 744);
pub const SOUND_COLOR_SPRITE: PathCursor = cursor(0, 754);
pub const CALLBACK_GATED_SPRITE: PathCursor = cursor(0, 571);
pub const PRIMARY_MOTION_GROUND_LIMITED: PathCursor = cursor(0, 493);
pub const PRIMARY_TARGET_FOLLOWER: PathCursor = cursor(0, 600);
pub const SHARED_COUNTDOWN_SERVICE: PathCursor = cursor(0, 35);
pub const COUNTER_MOTION_EFFECT: PathCursor = cursor(0, 185);
pub const PLAYER_CHARGE_ORB: PathCursor = cursor(0, 508);
...
pub const SURFACE_OR_GROUND_LIMITED: PathCursor = cursor(0, 396);
pub const PRIMARY_MOTION_SURFACE_LIMITED: PathCursor = cursor(0, 318);
pub const OCCUPANCY_SURFACE_LIMITED: PathCursor = cursor(0, 201);
pub const DOUBLED_MOTION_HOMING_PROJECTILE: PathCursor = cursor(0, 328);
pub const PRIMARY_MOTION_HOMING_PROJECTILE: PathCursor = cursor(0, 333);
pub const DIFFICULTY_HOMING_PROJECTILE: PathCursor = cursor(0, 339);
pub const VARIANT_GUIDED_PROJECTILE: PathCursor = cursor(0, 420);
pub const OFFSET_GUIDED_PROJECTILE: PathCursor = cursor(0, 234);
pub const LINKED_PROTECTION_EFFECT: PathCursor = cursor(0, 537);
pub const TRIGGERED_LINKED_PROJECTILE: PathCursor = cursor(0, 675);
pub const ATTACHED_RECOVERY_EFFECT: PathCursor = cursor(0, 609);
...
pub const HIT_TOGGLE_SPRITE: PathCursor = cursor(0, 136);
pub const COUNTED_HIT_TOGGLE_SPRITE: PathCursor = cursor(0, 135);
pub const GROWING_SPRITE_HOLD: PathCursor = cursor(0, 0);
pub const SHAPE_FILTERED_SCENERY: PathCursor = cursor(0, 98);
pub const LOWERED_ROOT_COUNT: usize = 36;
pub const LOWERED_COMMAND_COUNT: usize = 777;
pub const LOWERED_SOURCE_COMMAND_COUNT: usize = 786;
pub fn catalog() -> PathCatalog {
    PathCatalog::new(vec![vec![
        ...
        Statement::Control(ControlCommand::Register {
            trigger: Trigger::timed(cursor(0, 300), TriggerKind::Always, 13),
            next: cursor(0, 285),
        }),
        Statement::Control(ControlCommand::Hold),
        Statement::Control(ControlCommand::Cancel {
        ...
        Statement::UpdateProtectionEffect {
            ordinary_return: cursor(0, 556),
            flicker: cursor(0, 557),
        },
        Statement::Control(ControlCommand::Return),
        Statement::Mutate {
            mutation: Mutation::Byte {
        ...
        Statement::Control(ControlCommand::Register {
            trigger: Trigger::timed(cursor(0, 668), TriggerKind::Always, 35),
            next: cursor(0, 623),
        }),
        Statement::Contact {
            command: ContactCommand::RetainClass(ContactClassMask {
        ...
        Statement::Control(ControlCommand::Register {
            trigger: Trigger::timed(cursor(0, 666), TriggerKind::Always, 25),
            next: cursor(0, 629),
        }),
        Statement::Wait {
