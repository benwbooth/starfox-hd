...
const IS_CLSHIPSHIPA: usize = 25;
const IS_CLSHIPSHIPB: usize = 26;
const IS_CLSHIPSHIPC: usize = 27;
const IS_CLSHIPEARTHA: usize = 28;
const IS_CLSHIPEARTHB: usize = 29;
const IS_CLSHIPEARTHC: usize = 30;
const IS_CLSHIPTURNA: usize = 31;
const IS_CLSHIPTURNB: usize = 32;
const IS_CLSHIPTURNC: usize = 33;
const IS_CLSHIPBRIDGEA: usize = 34;
const IS_CLSHIPBRIDGEB: usize = 35;
const IS_CLSHIPBRIDGEC: usize = 36;
const IS_CLSHIPCHASEA: usize = 37;
const IS_CLSHIPCHASEB: usize = 38;
const IS_CLSHIPCHASEC: usize = 39;
const IS_CLSHIPDIVEA: usize = 40;
const IS_CLSHIPDIVEB: usize = 41;
const IS_CLSHIPDIVEC: usize = 42;
const IS_CLSHIPUNDERA: usize = 43;
const IS_CLSHIPUNDERB: usize = 44;
const IS_CLSHIPUNDERC: usize = 45;
