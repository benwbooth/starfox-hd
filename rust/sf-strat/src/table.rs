...
pub fn register_all(g: &mut Game) {
    ...
    for (addr, strat) in [
        ...
        (
            sf_map::consts::intro_strategy_address::PLAYER_DOWN,
            crate::intro::player_down_intro_init,
        ),
        (
            sf_map::consts::intro_strategy_address::PLAYER_DOWN_LEFT,
            crate::intro::player_down_left_intro_init,
        ),
        (
            sf_map::consts::intro_strategy_address::PLAYER_DOWN_RIGHT,
            crate::intro::player_down_right_intro_init,
        ),
        (
            sf_map::consts::intro_strategy_address::PLAYER_FIRE,
            crate::intro::player_fire_intro_init,
        ),
        (
            sf_map::consts::intro_strategy_address::ZACO,
            crate::intro::zaco_intro_init,
        ),
        (
            sf_map::consts::intro_strategy_address::ZACO_LEADER,
            crate::intro::zaco_leader_intro_init,
        ),
    ] {
