...
pub struct Config {
    ...
    pub buffer_size: i32,
    pub volume: i32,
    /// Optional source sound effects during General Pepper's stage briefing.
    pub pepper_briefing_sounds: bool,
    pub deadzone: f32,
}
    ...
    pub fn load(path: &Path) -> Config {
        ...
        for line in text.lines() {
            ...
            match (section.as_str(), key) {
                ...
                ("Audio", "PepperBriefingSounds") | ("Audio", "PepperTypewriterSound") => {
                    cfg.pepper_briefing_sounds = atoi(val) != 0;
                }
